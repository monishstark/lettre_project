...
public class Frlocation extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_frlocation);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng loc = new LatLng(lan, longt);
